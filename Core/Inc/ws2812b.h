...
#define WS2812B_T0H             26U   /* ~0.40 us at 64 MHz / 80 counts */
#define WS2812B_T1H             51U   /* ~0.80 us at 64 MHz / 80 counts */
 ...
 */
#if defined(WS2812B_DEBUG_COUNTERS) || defined(BRINGUP_TEST_MODE) || defined(COMPONENT_TEST_MODE)
