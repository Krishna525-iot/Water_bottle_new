...
/* ──────────────────────────────────────────────────────────────────────────
 *  BUILD MODE SELECT  (HydraSense — STM32G070KBT6)
 *  Uncomment ONE line to choose what main() runs. Leave BOTH commented for
 *  the normal full application (App_Init / App_Run).
 *
 *    COMPONENT_TEST_MODE : per-peripheral harness (component_test.c). Then
 *                          open component_test.h and comment/uncomment the
 *                          TEST_* switches to pick which parts are exercised.
 *    BRINGUP_TEST_MODE   : legacy RGB+NTC+TDS+HX711 self-test (bringup_test.c)
 *
 *  (You can instead define these in Project ▸ Properties ▸ C/C++ Build ▸
 *   Settings ▸ Preprocessor if you prefer not to edit this header.)
 * ────────────────────────────────────────────────────────────────────────── */
//#define COMPONENT_TEST_MODE
