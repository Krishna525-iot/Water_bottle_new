...
/* ─── Two-point calibration (CALLO / CALHI console commands) ──────────────────
 * Capture functions sample the probe at a known reference solution and store the
 * raw mV; TDS_CalSet/TDS_CalGet persist the pair via DeviceSettings_t. */
