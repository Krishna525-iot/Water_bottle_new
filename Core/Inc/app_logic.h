...
/* v2.1 one-button UX (sleep / ½-full-hour / factory-reset):
 *   tap  < BTN_FRESET_HOLD_MS               → single or double tap
 *   two taps within BTN_DOUBLE_MS           → double tap (½/full-hour toggle)
 *   hold ≥ BTN_FRESET_HOLD_MS               → factory-reset warning
 *   keep holding +BTN_FRESET_CONFIRM_MS     → factory reset executes         */
#define BTN_DEBOUNCE_MS           30U
#define BTN_DOUBLE_MS            400U
#define BTN_FRESET_HOLD_MS      5000U
#define BTN_FRESET_CONFIRM_MS   3000U
...
void App_MotionISR(void);     /* PA0  BMA253 any-motion — wake-from-sleep     */
void App_ButtonWakeISR(void); /* PB3  button edge       — wake-from-sleep     */
